...
INSERT INTO "user" (id, type, manager_user_id, tutor_user_id, collective_collective_id, institution_institution_id, login, password, can_login, name, surname1, surname2, birthdate, national_id, gender) VALUES
    ...
    (90003, 'CLIENT', null, 90002, null, null, 'testPet1', '$2a$10$B2oezu2FWCjEbFqarUFoeOlRy7bN0WKKY7Xxpd8EzBjLPQ.XqCeUa', false, 'Test', 'Client', 'Pet1', '2014-12-01', null, 'MALE'),
...
INSERT INTO session (id, client_user_id, client_notification_id, professional_user_id, professional_notification_id, service_id, availability_id, start_date, end_date, state) VALUES
