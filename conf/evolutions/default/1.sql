...
CREATE TYPE user_state AS ENUM ('UNCONFIRMED', 'CONFIRMED', 'DELEGATED', 'BANNED', 'DELETED');
...
CREATE TYPE transaction_reason AS ENUM ('SESSION_PAYMENT', 'SESSION_EARNINGS', 'SESSION_DEVOLUTION', 'TOP_UP', 'CASH_OUT', 'ADMIN_ACTION');
