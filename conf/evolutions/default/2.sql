...
INSERT INTO "user" (id, type, manager_user_id, tutor_user_id, collective_collective_id, institution_institution_id, email, password, can_login, name, surname1, surname2, birthdate, national_id, gender, balance, meta) VALUES
  ...
  (90005, 'PROFESSIONAL', null, null, null, null, 'testprofessional1@glue.gl', '$2a$10$N8/bNSwCRvgkLllU7dPqwOhnLRhunhrFuZAsq6hHoQceXDvQsdMAq', true, 'Test', 'Professional', 'User1', '1970-01-01', '99999999Z', 'MALE', 2300, '{}'),
  (90006, 'PROFESSIONAL', null, null, null, 90600, 'testprofessional2@glue.gl', '$2a$10$ujNb2RvpINeFHTDVtrH9HeVsFP0MxtRFeQf1tENXegtk7dOh9hl9K', true, 'Test', 'Professional', 'User2', '1970-12-31', '88888888Z', 'FEMALE', 31000, '{}'),
