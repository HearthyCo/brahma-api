...
INSERT INTO "user" (id, type, manager_user_id, tutor_user_id, collective_collective_id, institution_institution_id, email, password, can_login, name, surname1, surname2, birthdate, national_id, gender, confirmed, balance, meta) VALUES
  (90000, 'CLIENT', null, null, null, null, 'testclient1@glue.gl', '$2a$10$WsjgBbDB0uILyHoz7U7qIuTmWueom1f5AQ9fzlRlrQS1jtO9oeday', true, 'Test', 'Client', 'User1', '1987-12-25', '12345678Z', 'FEMALE', true, 20000000, '{}'),
  (90001, 'CLIENT', null, null, 90100, null, 'testclient2@glue.gl', '$2a$10$Fet.SSfzU013yDhiBFoyh.PTHE1HV/TR6DQZQ1beWVjTk.V2yllTe', true, 'Test', 'Client', 'User2', '1985-06-21', '23456789Z', 'MALE', true, 20, '{}'),
  (90002, 'TUTOR', null, null, null, null, 'testtutor1@glue.gl', '$2a$10$hyaM.y3UyCIKWmq/hXMr7Oqcd4KmryMIdFi7mQxH9iBH7ASM53CBe', true, 'Test', 'Tutor', 'User1', '1999-01-01', '34567890Z', 'FEMALE', true, 4, '{}'),
  (90003, 'CLIENT', null, 90002, null, null, 'testpet1@glue.gl', '$2a$10$9wC2cRkENN0hyQdfV9wny.GFdhd01iJixfCSynb8DKKnaBfWkj5q.', false, 'Test', 'Client', 'Pet1', '2014-12-01', null, 'MALE', true, 1000, '{}'),
  (90004, 'CLIENT', null, 90002, 90101, null, 'testpet2@glue.gl', null, false, 'Test', 'Client', 'Pet2', '2014-11-01', null, 'FEMALE', true, 20000, '{}'),
  (90005, 'PROFESSIONAL', null, null, null, null, 'testprofessional1@glue.gl', '$2a$10$N8/bNSwCRvgkLllU7dPqwOhnLRhunhrFuZAsq6hHoQceXDvQsdMAq', true, 'Test', 'Professional', 'User1', '1970-01-01', '99999999Z', 'MALE', true, 2300, '{}'),
  (90006, 'PROFESSIONAL', null, null, null, 90600, 'testprofessional2@glue.gl', '$2a$10$ujNb2RvpINeFHTDVtrH9HeVsFP0MxtRFeQf1tENXegtk7dOh9hl9K', true, 'Test', 'Professional', 'User2', '1970-12-31', '88888888Z', 'FEMALE', true, 31000, '{}'),
  (90007, 'COORDINATOR', null, null, null, null, 'testcoordinator1@glue.gl', '$2a$10$GKckVNVdU0MeMHoKi6B7ke8SW5BVOIscKjgm4gxYMV5hcT9ujW1rq', false, 'Test', 'Coordinator', 'User1', '1970-12-25', '77777777Z', 'MALE', true, 9000, '{}'),
  (90008, 'PROFESSIONAL', 90007, null, null, null, 'testhired1@glue.gl', '$2a$10$rk..ceMCVA73nlIKnll.d.qRtB61iIC2.Ruy.x5b2bR0JCgf1MSQ2', false, 'Test', 'Hired', 'User1', '1970-02-28', '66666666Z', 'FEMALE', true, 3400, '{}'),
  (90009, 'PROFESSIONAL', 90007, null, null, 90601, 'testhired2@glue.gl', '$2a$10$nDkLcWlv7BlDY0u/DlYFMOPQvoerzbnqd.QAMNYDz2N5b8DxHLG.W', false, 'Test', 'Hired', 'User2', '1970-03-25', '55555555Z', 'MALE', true, 9000, '{}');
...
INSERT INTO session (id, service_type_id, title, start_date, end_date, state, timestamp, meta) VALUES
  ...
  (90714, 90300, 'testPool3', '2015-02-14 19:00:00', '2015-02-21 17:15:00', 'REQUESTED', '2014-12-15 08:00:00', '{}'),
  (90715, 90300, 'testPool4', '2015-02-14 20:00:00', '2015-02-21 17:15:00', 'REQUESTED', '2014-12-15 08:00:00', '{}'),
...
INSERT INTO "session_user" (id, session_id, user_id, notification_id, service_id, availability_id, meta) VALUES
  ...
  (91619, 90714, 90002, null, null, null, '{}'),
  (91620, 90715, 90001, null, null, null, '{}'),
